...
class ComplianceCategoryTabs extends StatelessWidget {
  final int selectedCategory;
  final Function(int) onCategorySelected;

  const ComplianceCategoryTabs({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          _buildCategoryTab(
              localizationService.translate('businessActivity'), 0),
          SizedBox(width: 7.w),
          _buildCategoryTab(
              localizationService.translate('interestBearing'), 1),
          SizedBox(width: 7.w),
          _buildCategoryTab(
              localizationService.translate('interestBearingDebt'), 2),
        ],
      ),
    );
  }
