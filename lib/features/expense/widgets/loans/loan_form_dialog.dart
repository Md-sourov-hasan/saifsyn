...
class _LoanFormDialogState extends State<LoanFormDialog> {
  ...
  late final TextEditingController _repaymentPeriodController;
  ...
  void initState() {
    ...
    _amountController = TextEditingController(
      text: widget.loan == null
          ? ''
          : FinancialFormatters.amountInput(widget.loan!.amount),
    );
    _interestRateController = TextEditingController(
      text: widget.loan == null
          ? ''
          : FinancialFormatters.rateInput(widget.loan!.interestRate),
    );
    _repaymentPeriodController = TextEditingController(
      text: widget.loan == null ? '' : widget.loan!.repaymentPeriod.toString(),
    );
    _selectedStartDate = widget.loan?.startDate ?? DateTime.now();
  }
  ...
  Future<void> _submit() async {
    ...
    final isSuccess = widget.loan == null
        ? await widget.controller.createLoan(
            title: _titleController.text,
            amountText: _amountController.text,
            interestRateText: _interestRateController.text,
            repaymentPeriodText: _repaymentPeriodController.text,
            startDate: _selectedStartDate,
          )
        : await widget.controller.updateLoan(
            id: widget.loan!.id,
            title: _titleController.text,
            amountText: _amountController.text,
            interestRateText: _interestRateController.text,
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    FinancialFormatters.date(_selectedStartDate),
                    style: TextStyle(
      ...
      actions: [
        ...
        OutlinedButton(
          ...
          child: _isSubmitting
              ...
              : Text(widget.loan == null ? 'Save' : 'Update'),
        ),
      ],
    );
  }
